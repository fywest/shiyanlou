...
FOR EACH ROW 
BEGIN
	INSERT INTO modifymark VALUES(NEW.mid,NEW.sid,NEW.cid,NEW.score,NOW());
END $$
...
BEGIN
	SELECT cname,sname,score FROM course,student,mark WHERE student.sid=mark.sid AND course.cid=mark.cid AND course.cname='math' ORDER BY mark.score DESC;  
END $$
